  ...
  {:else}
    ...
    <div style="display:flex;align-items:center;gap:14px;padding:2px 4px 22px">
      <div style="width:52px;height:52px;border-radius:16px;overflow:hidden;background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center;flex-shrink:0">
        ...
        {:else}
          <svg width="24" height="24" fill="rgba(255,255,255,.55)" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
        {/if}
      </div>
    ...
    <div class="settings-group">
      <button class="settings-item" on:click={_openProfile}>
        <span class="settings-item-icon">
          <svg width="19" height="19" fill="rgba(245,245,245,.62)" viewBox="0 0 24 24"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
        </span>
      ...
      <button class="settings-item" on:click={_openConnectedAccounts}>
        <span class="settings-item-icon">
          <svg width="19" height="19" fill="rgba(245,245,245,.62)" viewBox="0 0 24 24"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1zM8 13h8v-2H8v2zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5z"/></svg>
        </span>
        <span class="settings-item-text">
    ...
    <div class="settings-group">
      <button class="settings-item" on:click={() => goto('/library?tab=recent')}>
        <span class="settings-item-icon">
          <svg width="19" height="19" fill="rgba(245,245,245,.62)" viewBox="0 0 24 24"><path d="M13 3a9 9 0 1 0 .001 18.001A9 9 0 0 0 13 3zm0 16c-3.86 0-7-3.14-7-7s3.14-7 7-7 7 3.14 7 7-3.14 7-7 7zm.5-11H12v6l5.25 3.15.75-1.23-4.5-2.67V8z"/></svg>
        </span>
        <span class="settings-item-text">
      ...
      <button class="settings-item" on:click={() => goto('/library?tab=liked')}>
        <span class="settings-item-icon">
          <svg width="19" height="19" fill="rgba(245,245,245,.62)" viewBox="0 0 24 24"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>
        </span>
        <span class="settings-item-text">
      ...
      <button class="settings-item" on:click={() => _sheet = 'clearData'}>
        <span class="settings-item-icon">
          <svg width="19" height="19" fill="rgba(245,245,245,.62)" viewBox="0 0 24 24"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/></svg>
        </span>
        <span class="settings-item-text">
    ...
    <div class="settings-group">
      <button class="settings-item" on:click={() => _sheet = 'appearance'}>
        <span class="settings-item-icon">
          <svg width="19" height="19" fill="rgba(245,245,245,.62)" viewBox="0 0 24 24"><path d="M12 3C7.03 3 3 7.03 3 12s4.03 9 9 9c.83 0 1.5-.67 1.5-1.5 0-.39-.15-.74-.39-1.01-.23-.26-.38-.61-.38-.99 0-.83.67-1.5 1.5-1.5H16c2.76 0 5-2.24 5-5 0-4.42-4.03-8-9-8zm-5.5 9c-.83 0-1.5-.67-1.5-1.5S5.67 9 6.5 9 8 9.67 8 10.5 7.33 12 6.5 12zm3-4C8.67 8 8 7.33 8 6.5S8.67 5 9.5 5s1.5.67 1.5 1.5S10.33 8 9.5 8zm5 0c-.83 0-1.5-.67-1.5-1.5S13.67 5 14.5 5s1.5.67 1.5 1.5S15.33 8 14.5 8zm3 4c-.83 0-1.5-.67-1.5-1.5S16.67 9 17.5 9s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"/></svg>
        </span>
        <span class="settings-item-text">
      ...
      <button class="settings-item" on:click={() => _sheet = 'theme'}>
        <span class="settings-item-icon">
          <svg width="19" height="19" fill="rgba(245,245,245,.62)" viewBox="0 0 24 24"><path d="M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9c0-.46-.04-.92-.1-1.36-.98 1.37-2.58 2.26-4.4 2.26-2.98 0-5.4-2.42-5.4-5.4 0-1.81.89-3.42 2.26-4.4-.44-.06-.9-.1-1.36-.1z"/></svg>
        </span>
        <span class="settings-item-text">
    ...
    <div class="settings-group">
      <button class="settings-item" on:click={() => goto('/settings/about')}>
        <span class="settings-item-icon">
          <svg width="19" height="19" fill="rgba(245,245,245,.62)" viewBox="0 0 24 24"><path d="M11 7h2v2h-2V7zm0 4h2v6h-2v-6zm1-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/></svg>
        </span>
        <span class="settings-item-text">
      ...
      <button class="settings-item" on:click={() => goto('/settings/privacy')}>
        <span class="settings-item-icon">
          <svg width="19" height="19" fill="rgba(245,245,245,.62)" viewBox="0 0 24 24"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"/></svg>
        </span>
        <span class="settings-item-text">
      ...
      <button class="settings-item" on:click={() => goto('/settings/terms')}>
        <span class="settings-item-icon">
          <svg width="19" height="19" fill="rgba(245,245,245,.62)" viewBox="0 0 24 24"><path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>
        </span>
        <span class="settings-item-text">
    ...
    <div style="width:100%;max-width:340px;max-height:85vh;overflow-y:auto;background:#1c1c1c;border-radius:18px;padding:22px 20px;border:1px solid rgba(255,255,255,.12)"
      ...
      {:else if _sheet === 'clearData'}
        ...
        <button class="sheet-danger-row" on:click={() => _confirmAction = 'clear_history'}>
          <svg width="18" height="18" fill="rgba(255,100,100,.75)" viewBox="0 0 24 24"><path d="M13 3a9 9 0 1 0 .001 18.001A9 9 0 0 0 13 3zm0 16c-3.86 0-7-3.14-7-7s3.14-7 7-7 7 3.14 7 7-3.14 7-7 7zm.5-11H12v6l5.25 3.15.75-1.23-4.5-2.67V8z"/></svg>
          <span>Hapus Semua Riwayat</span>
        </button>
        <button class="sheet-danger-row" on:click={() => _confirmAction = 'clear_liked'}>
          <svg width="18" height="18" fill="rgba(255,100,100,.75)" viewBox="0 0 24 24"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>
