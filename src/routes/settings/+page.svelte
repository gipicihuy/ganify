...
<div style="max-width:560px;margin:0 auto;padding:24px 16px 0;min-height:70vh;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center">

  <div style="width:84px;height:84px;border-radius:24px;background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);display:flex;align-items:center;justify-content:center;margin-bottom:24px">
  ...
  <div style="display:inline-flex;align-items:center;gap:6px;padding:5px 12px;border-radius:99px;background:rgba(255,165,0,0.1);border:1px solid rgba(255,165,0,0.25);margin-bottom:18px">
    <span style="width:6px;height:6px;border-radius:50%;background:#FFA500;flex-shrink:0"></span>
    <span style="font-size:.65rem;font-weight:700;color:rgba(255,180,0,.9);letter-spacing:.05em">SEGERA HADIR</span>
  </div>

  <h1 style="font-size:1.4rem;font-weight:700;color:#FFFFFF;margin:0 0 10px">Settings</h1>
  <p style="font-size:.82rem;color:rgba(245,245,245,.5);line-height:1.6;margin:0 0 32px;max-width:340px">Login, ganti nama, foto profil, dan pengaturan akun lainnya lagi disiapkan. Pantengin terus ya!</p>

  <button on:click={handleGoogleSignIn}
    style="width:100%;max-width:320px;padding:13px;border-radius:14px;border:1px solid rgba(255,255,255,0.2);background:#FFFFFF;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:10px;transition:all .15s">
